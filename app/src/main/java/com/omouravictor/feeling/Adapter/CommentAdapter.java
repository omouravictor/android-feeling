...
import com.omouravictor.feeling.MainActivity;
import com.omouravictor.feeling.Model.Comment;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final CommentAdapter.ImageViewHolder holder, final int position) {
        ...
        holder.deleteIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialog.setTitle("Deseja excluir o comentário?");
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView image_profile, deleteIcon;
